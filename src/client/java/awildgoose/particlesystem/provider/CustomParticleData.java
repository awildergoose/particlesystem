...
public class CustomParticleData {
    public static final CustomParticleData DEFAULT = new CustomParticleData(AnimatedFloat.ONE, 20, CustomParticleTexture.WISP, AnimatedFloat.ZERO, AnimatedColor.WHITE, 0, 0, 0, new ArrayList<>(), new ArrayList<>());
    ...
    public CustomParticleData(AnimatedFloat size, int lifetime, CustomParticleTexture texture, AnimatedFloat angle, AnimatedColor color, double velocityX, double velocityY, double velocityZ, ArrayList<Action> tickActions, ArrayList<Action> renderActions) {
        this.size = size;
